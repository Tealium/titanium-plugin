exports.AppTabGroup = function() {
	...
	self.addEventListener('focus', function(e) {
		...
		// *** TEALIUM *** - Trace the view change
		Tealium.trackViewEvent('tab:view change');
		// *** TEALIUM *** - Alternatively track view change with additional info
		//Tealium.trackViewEvent('tab:view change', {"customKey1":"customValue1"});
		
		// *** TEALIUM *** - Track focus event
		Tealium.onFocus();
	});

	// *** TEALIUM *** - Track blur events
